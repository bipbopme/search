...
export function getInsertIndex(resultIndex = 0, options = {}) {
  const opts = { ...{ improveRankBy: 2, minIndex: 0, maxIndex: 4 }, ...options };
...
export function getProxyImageUrl(imageUrl) {
  return getSignedUrl('/api/images/proxy', { url: imageUrl });
}
